...
CHECKPOINTS_DIR=/scratch/ychen855/hand_gesture/PyTorch_YOLOv3/checkpoints
EPOCHS=60

python ${PYTHON} --model ${MODEL} --epochs ${EPOCHS} --data ${DATA} --pretrained_weights ${PRETRAINED_WEIGHTS} --checkpoints_dir ${CHECKPOINTS_DIR}