...
def run():
    ...
    parser.add_argument("-se", "--start_epoch", type=int, default=0, help="Start training from which epoch")
    ...
    for epoch in range(args.start_epoch + 1, args.epochs + args.start_epoch + 1):
        ...
        if epoch % args.checkpoint_interval == 0:
            checkpoint_path = os.path.join(args.checkpoints_dir, str(epoch) + '.pth')
